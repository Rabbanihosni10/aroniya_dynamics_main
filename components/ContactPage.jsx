...
const services = ['App Dev', 'Web Dev', 'AI Systems', 'Data Analytics', 'SEO', 'Networking', 'System Design', 'Consultancy']
        ...
        <div className="grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:gap-16">
          <motion.aside initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="flex flex-col justify-between gap-12 py-2">
            <div className="space-y-8">
              <div className="flex gap-4"><span className="contact-icon"><Mail size={18} /></span><div><p className="footer-label">Email</p><a href="mailto:info@aroniadynamics.com" className="mt-2 block text-sm transition-colors hover:text-primary">info@aroniadynamics.com</a></div></div>
              <div className="flex gap-4"><span className="contact-icon"><Phone size={18} /></span><div><p className="footer-label">Phone</p><p className="mt-2 text-sm leading-6 text-muted-foreground">+880-1XXX-XXXXXX (BD)<br />+1-XXX-XXX-XXXX (USA)</p></div></div>
              <div className="flex gap-4"><span className="contact-icon"><MapPin size={18} /></span><div><p className="footer-label">Studios</p><p className="mt-2 text-sm leading-6 text-muted-foreground">Bangladesh: [Dhaka Address Placeholder]<br />USA: [US Address Placeholder]</p></div></div>
            </div>
            <div><p className="footer-label">Follow along</p><div className="mt-4 flex gap-3"><a href="#facebook" aria-label="Facebook" className="social-link"><Globe2 size={17} /></a><a href="#instagram" aria-label="Instagram" className="social-link"><Send size={16} /></a><a href="#linkedin" aria-label="LinkedIn" className="social-link"><BriefcaseBusiness size={16} /></a></div></div>
          </motion.aside>
